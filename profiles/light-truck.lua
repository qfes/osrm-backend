...
function setup()
  return {
    ...
    vehicle_height = 2.7, -- in meters, 2.0m is the height slightly above biggest SUVs
    vehicle_width = 2.45, -- in meters, ways with narrow tag are considered narrower than 2.2m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 5.9, -- in meters, 4.8m is the length of large or family car
    ...
    classes = Sequence {
        'toll', 'motorway', 'ferry', 'restricted', 'tunnel', 'construction', 'proposed'
    },
